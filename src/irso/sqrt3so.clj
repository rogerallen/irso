...
;; ======================================================================
;; the song
(defn ^:dynamic calc-sqrt3so [beat tonic type]
  (let [irno-seq sqrt3-1000
        ...
        seq3r (calc-seq-irno-repeat seq3 4 (drop (* 2 23) irno-seq))
        ...
        theme-seq3r-start (+ theme-start (* 1 (num-beats seq1)))
...
(defn ^:dynamic sqrt3so [m beat tonic type]
  (let [seq-list (calc-sqrt3so beat tonic type)]

...
(defn ^:dynamic tauso [m beat tonic type]
  (let
    [seq1 (calc-seq tonic type 13 0 tau-1000)
     seq2 (calc-seq tonic type 17 (count seq1) tau-1000)
     seq3 (calc-seq tonic type 19 (+ (count seq1) (count seq2)) tau-1000)
     ...
     b013 (play-repeated-snote-seq sampled-piano m b010 tonic type seq1 3 tau-1000)
     b014 (play-repeated-snote-seq sampled-piano m b011 tonic type seq2 2 tau-1000)
     b015 (play-repeated-snote-seq sampled-piano m b012 tonic type seq3 2 tau-1000)

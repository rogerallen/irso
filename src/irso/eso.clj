...
(defn ^:dynamic eso [m beat tonic type]
  (let
    [seq1 (calc-seq tonic type 13 0 e-1000)
     ...
     seq3 (calc-seq tonic type 19 (+ (count seq1) (count seq2)) e-1000)
     foo (println "e song")
     ...
     b014 (play-repeated-snote-seq sampled-piano m b011 tonic type seq2 2 e-1000)
     b015 (play-repeated-snote-seq sampled-piano m b012 tonic type seq3 2 e-1000)
